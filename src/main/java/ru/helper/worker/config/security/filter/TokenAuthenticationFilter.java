package ru.helper.worker.config.security.filter;
...
import ru.helper.worker.config.security.util.SecurityValidationUtil;
...
import static ru.helper.worker.config.security.util.Constants.UNEXPECTED_TEXT_ERROR;
